---
name: web-agent
description: Next.js 16 routes, server components, client islands. Also the webOS target.
...
```
op-cli claim   --wp <id> --agent web-agent   # refuses if the paths are not yours
